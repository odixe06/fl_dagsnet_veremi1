...
"""Poll W&B (and optionally the Kaggle kernel status) for the production NILM-FL runs.
    ...
    python scripts/watch_prod.py nilm_20c nilm_50c nilm_100c
    python scripts/watch_prod.py nilm_20c --kernel minhtriethihi/nilm-fl-veremi-20-clients \
        --every 300
...
def main():
    ...
    ap.add_argument("--project", default="21522798-uit/nilm-veremi")
