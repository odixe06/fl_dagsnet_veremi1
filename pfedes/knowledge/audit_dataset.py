...
ROOT = Path("/home/odixe/nckh/veremi/dataset")
FL   = ROOT / "fl_client/alpha05"
TEST = ROOT / "centralized/test"
META = json.load(open("/home/odixe/nckh/veremi/tinyproto/knowledge/meta.json"))
SCAL = json.load(open("/home/odixe/nckh/veremi/tinyproto/knowledge/scaler.json"))
...
Path(__file__).with_name("dataset_audit.json").write_text(json.dumps(out, indent=2))
