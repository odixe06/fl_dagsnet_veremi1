#!/usr/bin/env python
"""Verify a downloaded run directory offline: per-client metrics == confusion == weights ==
history/clients CSV, carried-forward matrices unchanged, predictions rebuild the matrices.

    python scripts/verify_run.py papers/pfedes-yi-2025/runs/pfedes_20c --require-rounds 50
...
ok, lines = verify_run(a.run_dir, cfg=cfg,
                       ...
                       build_proxy=None if a.no_rebuild else build_proxy,
                       expect_model=None if a.no_rebuild else N_PARAMS_MODEL,
                       expect_proxy=None if a.no_rebuild else N_PARAMS_PROXY,
